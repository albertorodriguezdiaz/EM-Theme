...
function _scripts() {
	...
	wp_enqueue_style('foundationCss','http://dhbhdrzi4tiry.cloudfront.net/cdn/sites/foundation.min.css');
	wp_enqueue_style('uijquerycss', 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css');
	wp_enqueue_style('FAwesome','//use.fontawesome.com/releases/v5.6.3/css/all.css');
	wp_enqueue_style('estilo-css', get_template_directory_uri().'/css/app.css');

	wp_enqueue_script('jquery');

	wp_enqueue_script('foundation-jquery','//code.jquery.com/jquery-2.1.4.min.js');
	wp_enqueue_script('foundation-input','//cdnjs.cloudflare.com/ajax/libs/what-input/4.2.0/what-input.min.js');
	wp_enqueue_script('foundation-foundation','//dhbhdrzi4tiry.cloudfront.net/cdn/sites/foundation.js');
