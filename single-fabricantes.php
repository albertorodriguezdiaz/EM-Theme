 	...
 	<main id="main" class="site-main">
 		...
 		<div class="row detallesProducto paginaInterna">
 			...
 			<div class="column large-8 medium-12">
 				...
 				<p class="codigoProducto">Código: <?php the_field('codigo'); ?></p>

 				<div class="formularioProductos">
 					<?php echo do_shortcode('[contact-form-7 id="1625" title="Contacto Fabricantes"]'); ?>
 					...
 					<script type="text/javascript">
 						var url = jQuery(location).attr('href');
							...
							jQuery(document).ready(function(){
								jQuery('.wpcf7-form-control-wrap.id input').val('<?php the_field('codigo'); ?>');
